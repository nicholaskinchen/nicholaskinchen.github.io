    ...
    window.opspark.makeProjectileManager = function (view, space, particleManager) {
        ...
        _projectileManager = {
            fire: function (emitter) {
                ...
                createjs.Tween.get(projectile, {override: true}).wait(1).to({alpha: 0, scaleX: 1, scaleY: 1}, 1000, createjs.Ease.linear).call(onTweenComplete);
